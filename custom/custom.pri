...
TARGET   = Sun-J
DEFINES += QGC_APPLICATION_NAME='"\\\"SUN-J\\\""'

DEFINES += QGC_ORG_NAME=\"\\\"sunj.org\\\"\"
DEFINES += QGC_ORG_DOMAIN=\"\\\"org.sunj\\\"\"

QGC_APP_NAME        = "SUN-J"
QGC_BINARY_NAME     = "Sun-J"
QGC_ORG_NAME        = "Sun-J"
QGC_ORG_DOMAIN      = "org.sunj"
QGC_ANDROID_PACKAGE = "org.sunj.groundcontrol"
QGC_APP_DESCRIPTION = "SUN-J Ground Control"
QGC_APP_COPYRIGHT   = "Copyright (C) 2024 Sun-J Development Team. All rights reserved."
...
SOURCES += \
    ...
    $$PWD/src/widgetanchor.cpp \
    $$PWD/src/widgetcontainer.cpp

HEADERS += \
    $$PWD/src/CustomPlugin.h \
    $$PWD/src/widgetanchor.h \
    $$PWD/src/widgetcontainer.h
